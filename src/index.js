...
const projectsArray = [
  {
    title: 'Captionr',
    description: 'A caption contest application where users can post pictures, leave captions, up or downvote captions.',
    liPoints:[
        'As a group of two, formatted a single page Vanilla JS application to allow users to view all pictures and top voted captions.',
  ...
  },
  {
    title: 'Bgft',
     ...
     liPoints:[
       'As a group of two, implemented Leaflet to provide users with an interactive map to post and view sightings.',
    ...
    },
    {
      ...
      liPoints:[
        'Built search functionality in React components to allow user to search restaurants through the navbar.',
        'Generated an API based on requests from Yelp’s API to allow frontend developers to easily access the relevant information.',
        ...
        'Worked with a combination of Materialize and custom CSS for an intuitive and styled user experience.'
      ],
